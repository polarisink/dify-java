 ...
 * @param docForm
 */
public record DifyDocument(String id, Integer position, @JsonAlias("data_source_type") String dataSourceType,
                           ...
                           @JsonAlias("created_at") Instant createdAt, Integer tokens,
     ...
     * @param uploadFileId
     */
    public record DataSourceInfo(@JsonAlias("upload_file_id") String uploadFileId) {
    }
}